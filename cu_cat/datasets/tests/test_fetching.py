...
def test_openml_fetching(fetch_openml_mock: mock.Mock):
    ...
    see https://github.com/cu_cat-data/cu_cat/issues/523
    """
...
from cu_cat.datasets._utils import get_data_dir as _get_data_dir
...
@mock.patch("cu_cat.datasets._fetching.Path.is_file")
@mock.patch("cu_cat.datasets._fetching._get_features")
@mock.patch("cu_cat.datasets._fetching._get_details")
@mock.patch("cu_cat.datasets._fetching._export_gz_data_to_csv")
@mock.patch("cu_cat.datasets._fetching._download_and_write_openml_dataset")
...
@mock.patch("cu_cat.datasets._fetching._read_json_from_gz")
...
@mock.patch("cu_cat.datasets._fetching._fetch_openml_dataset")
@mock.patch("cu_cat.datasets._fetching._fetch_dataset_as_dataclass")
