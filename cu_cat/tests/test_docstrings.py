...
cu_cat are formatted according to numpydoc specifications.
...
DOCSTRING_TEMP_IGNORE_SET = {
    "cu_cat._table_vectorizer.SuperVectorizer",
    # The following are not documented in cu_cat (and thus are out of scope)
    # They are usually inherited from other libraries.
    "cu_cat._table_vectorizer.TableVectorizer.fit",
    "cu_cat._table_vectorizer.TableVectorizer.set_params",
    "cu_cat._table_vectorizer.TableVectorizer.named_transformers_",
    "cu_cat._table_vectorizer.SuperVectorizer.fit",
    "cu_cat._table_vectorizer.SuperVectorizer.set_params",
    "cu_cat._table_vectorizer.SuperVectorizer.named_transformers_",
    # The following are internal functions
    "cu_cat._check_dependencies.check_dependencies",
}


def get_public_classes():
    module = import_module("cu_cat")
